            ...
            <li key={step.name}>
              {step.status === 'complete' ? (
                ...
                <a href={step.href} aria-current="step" className="flex items-start">
                  <span aria-hidden="true" className="relative flex h-5 w-5 flex-shrink-0 items-center justify-center">
                ...
                <a href={step.href} className="group">
                  <div className="flex items-start">
                    <div aria-hidden="true" className="relative flex h-5 w-5 flex-shrink-0 items-center justify-center">
